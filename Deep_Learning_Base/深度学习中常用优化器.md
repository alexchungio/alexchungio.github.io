...
SGDM[Sutskever et al., 2013]  动量算法引入了动量$v$充当速度角色，它代表参数在参数空间移动的方向和速m率。速度被设为负梯度的指数移动平均。动量在物理上定义为质量乘以速度，这里我们假设是单位质量， 因此速度$m$也看作是粒子的动量。
...
![image-20200803082556002](../graph/image-20200803082556002.png)

​		已经有很多论文证明，Adam 在训练阶段收敛速度很快，且能够达到较高的准确率；但是泛化能力有时并非最优。

![image-20200803083000776](../graph/image-20200803083000776.png)
